    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('archive', models.FileField(null=True, upload_to=kushillu.models.archive_dir, blank=True)),
            ],
            options={
                'ordering': ['-id'],
                'verbose_name': 'Build',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('docker_image', models.CharField(default=b'kushillu', help_text=b'Name of the docker image to use for CI.', max_length=100, verbose_name=b'docker image')),
        ...
        migrations.AddField(
            ...
            name='project',
            field=models.ForeignKey(related_name=b'builds', to='kushillu.Project'),
